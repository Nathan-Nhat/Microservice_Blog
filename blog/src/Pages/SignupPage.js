...
const LoginPage = () => {
    ...
    return (
        <Paper className={classes.container}>
            ...
            <TextField required id="standard-required" label="Name" type="text" name = 'name' onChange={handleChange}/>
            <TextField required id="standard-required" label="Email" type="email" name = 'email' onChange={handleChange}/>
